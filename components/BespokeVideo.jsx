...
function BespokeVideo() {
  ...
  return (
    <div className="h-screen w-full dark:bg-black bg-white dark:bg-grid-red/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
      ...
      <div
        ref={ref}
        className="flex flex-col md:flex-row justify-center items-center gap-8 h-screen px-2 md:px-8"
      >
        <div className="w-11/12 md:w-3/5 relative">
          ...
          >
            <source src="/videos/modern.mp4" type="video/mp4" />
        ...
        <div className="text w-11/12 md:w-2/5">
          <h2 className="font-regular text-black text-4xl md:text-5xl text-center md:text-left">
